...
import * as import1 from '../../src/app.component';
...
import * as import11 from 'mwl-example-ng2-module/dist/src/demo.component';
import * as import12 from '../node_modules/mwl-example-ng2-module/dist/src/demo.component.ngfactory';
...
const nodeDebugInfos_AppComponent0:import0.StaticNodeDebugInfo[] = [
  ...
  new import0.StaticNodeDebugInfo([import11.DemoComponent],import11.DemoComponent,{})
]
;
...
class _View_AppComponent0 extends import3.DebugAppView<import1.AppComponent> {
  ...
  _DemoComponent_1_4:import11.DemoComponent;
  constructor(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import4.AppElement) {
  ...
  createInternal(rootSelector:string):import4.AppElement {
    ...
    this._text_0 = this.renderer.createText(parentRenderNode,'Yo: ',this.debug(0,0,0));
    this._el_1 = this.renderer.createElement(parentRenderNode,'demo',this.debug(1,0,4));
    this._appEl_1 = new import4.AppElement(1,(null as any),this,this._el_1);
    var compView_1:any = import12.viewFactory_DemoComponent0(this.viewUtils,this.injector(1),this._appEl_1);
    this._DemoComponent_1_4 = new import11.DemoComponent();
    this._appEl_1.initComponent(this._DemoComponent_1_4,[],compView_1);
    compView_1.create(this._DemoComponent_1_4,[],(null as any));
    this.init([],[
      this._text_0,
      this._el_1
    ]
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import11.DemoComponent) && (1 === requestNodeIndex))) { return this._DemoComponent_1_4; }
    return notFoundResult;
  }
}
export function viewFactory_AppComponent0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import4.AppElement):import3.AppView<import1.AppComponent> {
  if ((renderType_AppComponent === (null as any))) { (renderType_AppComponent = viewUtils.createRenderComponentType('/Users/mattlewis/Code/open-source/angular2-compiler-bug/src/app.component.ts class AppComponent - inline template',0,import9.ViewEncapsulation.None,styles_AppComponent,{})); }
